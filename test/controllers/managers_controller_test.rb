...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { document: @manager.document, lastName: @manager.lastName, personId: @manager.personId, personName: @manager.personName, personStatus: @manager.personStatus, telephone: @manager.telephone }
    end
  ...
  test "should update manager" do
    patch :update, id: @manager, manager: { document: @manager.document, lastName: @manager.lastName, personId: @manager.personId, personName: @manager.personName, personStatus: @manager.personStatus, telephone: @manager.telephone }
    assert_redirected_to manager_path(assigns(:manager))
  end
